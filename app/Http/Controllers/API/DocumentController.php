...
class DocumentController extends Controller
{
    ...
    public function generateWord($conversationId)
    {
        ...
        $section->addText("Generated by AI Lawyer", ['bold' => true, 'size' => 12, 'italic' => true]);
        $section->addTextBreak(2);
        $section->addText("Topic: " . $conversation->topic, ['bold' => true, 'size' => 12]);
        $section->addText("Generated on: " . date('d.m.Y'), ['size' => 10, 'italic' => true]);
        $section->addTextBreak(2);
    ...
    public function generateDocumentFromChatbot($conversationId)
    {
        ...
        $instructions = match ($conversation->document_type) {
            'tužba' => 'Generate a legal document in the form of a lawsuit with relevant legal bases and claims.',
            'ugovor' => 'Generate a legal document in the form of a sales contract with clauses, rights, and obligations of the parties.',
            default => 'Generate a legal document based on the conversation.',
        };
